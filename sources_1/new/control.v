...
//combined control with ALU control
    ...
    module control(  
        ...
        output reg jalr_sel,
        output reg jal_sel //selects PC+4 for writeback
    );
    ...
    //auipc, jal, jalr, not implemented yet
        ...
        case (opcode)
            ...
            immediate_opcode : begin
                ...
                case (funct3) 
                    ...
                    3'b010 : ALU_control = 4'b1011; //slti uses slt
                    3'b011 : ALU_control = 4'b1100; //sltiu uses sltu
