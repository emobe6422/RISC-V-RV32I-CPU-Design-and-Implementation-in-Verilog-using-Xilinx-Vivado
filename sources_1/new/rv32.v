...
module rv32(
    ...
    //input wire [6:0] funct7;
     wire  branch, mem_read, mem_to_reg, 
           mem_write, ALU_src, jump, jal_sel, jalr_sel;
     wire reg_write;
    ...
    //load extender instantiation
    load_extender load_extender(
        .raw_data(read_data),
        .funct3(funct3),
    ...
    //assign write_data = (mem_to_reg == 1) ? extended_data : sum; 
    assign write_data = (jal_sel) ? PC_plus4 :
                    (mem_to_reg) ? extended_data : sum;
    ...
    //test sb and sh to confirm they work
